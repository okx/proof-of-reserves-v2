...
//     let mut builder: CircuitBuilder<GoldilocksField, 2> = CircuitBuilder::<F, D>::new(STANDARD_CONFIG);
//     let mut pw = PartialWitness::<GoldilocksField>::new();
//     let mut account_targets: Vec<AccountTargets> = Vec::new();

//     for i in 0..accounts.len() {
//         let asset_targets = HashOutTarget::default(),builder.add_virtual_targets(accounts.get(i).unwrap().assets.len());
