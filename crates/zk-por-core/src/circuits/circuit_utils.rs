use std::panic;
use log::Level;
use plonky2::{hash::hash_types::{HashOutTarget, RichField}, iop::{target::BoolTarget, witness::PartialWitness}, plonk::{circuit_builder::CircuitBuilder, circuit_data::CircuitData, config::GenericConfig, prover::prove}, util::timing::TimingTree};
use plonky2_field::extension::Extendable;

use crate::{circuits::circuit_config::STANDARD_CONFIG, types::C};
